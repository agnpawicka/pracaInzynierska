...
\englishabstract{The thesis contains implementation and description of an extension to Google Forms service. This extension provides automatical forms generation from JSON file, conversion of mathematical symbols (written in \LaTeX{}) and some forms properties managment (for existing forms). This paper also describes used technologies and suggest how presented extension could be developed.  }
